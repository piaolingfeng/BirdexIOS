...
(function ($) {
    ...
    function Scroller(elem, settings) {
        ...
        */
        ...
        if (!EventBus.hasEventListener("qingkong")){
            EventBus.addEventListener("qingkong", function(){
                that.cancel();
                console.log(that);
            }, this);
        } else {
            if (!EventBus.hasEventListener("qingkong1")){
                EventBus.addEventListener("qingkong1", function(){
                    that.cancel();
                    console.log(that);
                }, this);
            }
