                ...
                if (obj1.detail != null && obj1.detail != undefined) {
                    ...
                    eles.push(
                        <span style={{ fontSize: "14px" }}>
                            <span style={{ color: "#979797" }}>{name}: </span>
                            <span style={{ color: "#039FFF" }}>{count}</span>
                        </span>);
                }
            });
        }
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style={{ width: "25%", textAlign: "center" }}>
                                <span style={{ color: "#979797", fontSize: "14px" }}>待入库数</span>
                                <br/>
                                <span style={{ color: "#039FFF", fontSize: "18px" }}>{allcount}</span>
                            </td>
                        </tr>
